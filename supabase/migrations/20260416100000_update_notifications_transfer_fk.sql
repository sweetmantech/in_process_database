...
CREATE INDEX idx_in_process_notifications_transfer ON in_process_notifications (transfer);

-- Update table comment
COMMENT ON TABLE in_process_notifications IS 'Notifications for paid transfer events in the in-process system';

COMMENT ON COLUMN in_process_notifications.transfer IS 'Foreign key reference to in_process_transfers table';
