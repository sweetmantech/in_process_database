...
CREATE INDEX IF NOT EXISTS idx_in_process_artists_username_lower
  ON public.in_process_artists (LOWER(username));
...
CREATE INDEX IF NOT EXISTS idx_in_process_admins_artist_address
  ON public.in_process_admins (artist_address);
