...
-- ---------------------------------------------------------------------------
CREATE UNIQUE INDEX in_process_artist_phones_artist_id_unique ON public.in_process_artist_phones (artist_id);

ALTER TABLE public.in_process_artist_phones
ADD CONSTRAINT in_process_artist_phones_artist_id_unique UNIQUE USING index in_process_artist_phones_artist_id_unique;

-- ---------------------------------------------------------------------------
-- 8. FK to in_process_artists
-- ---------------------------------------------------------------------------
ALTER TABLE public.in_process_artist_phones
ADD CONSTRAINT in_process_artist_phones_artist_id_fkey FOREIGN key (artist_id) REFERENCES public.in_process_artists (id) ON UPDATE CASCADE ON DELETE CASCADE;
