-- Remove content.uri filter from p_mime IS NULL branches in all 3 timeline RPCs.
-- When no mime filter is applied, moments without a content.uri should still appear.
-- ── get_artist_timeline ───────────────────────────────────────────────────────
