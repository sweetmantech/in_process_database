-- When p_chainid IS NULL, restrict to prod chains (1, 10, 8453) to exclude
-- testnet chains such as Base Sepolia (84532).
-- When p_chainid IS NOT NULL, keep the existing exact-match behaviour.
-- ── get_artist_timeline ───────────────────────────────────────────────────────
