-- Exclude moments where content.uri is NULL/empty or external_url is a placeholder
-- (/collect/base:...) from all 3 timeline RPCs.
-- Index: see 20260519000000_add_content_uri_exists_index.sql
...
-- ── get_artist_timeline ──────────────────────────────────────────────────────
-- Drop both old signatures (9-param without p_curated, 10-param with p_curated).
