...
CREATE OR REPLACE FUNCTION public.in_process_artists_address_lowercase () returns trigger language plpgsql AS $function$
BEGIN
...
BEFORE INSERT OR UPDATE OF address ON public.in_process_artists FOR EACH ROW
