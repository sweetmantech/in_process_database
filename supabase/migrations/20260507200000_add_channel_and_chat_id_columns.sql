...
SET
  channel = mmd.client::TEXT
FROM
  public.in_process_message_moment mm
...
INSERT INTO
  public.account_notifications (artist_address, telegram_chat_id)
SELECT
  lc.artist_address,
  lc.chat_id
FROM
  (
    SELECT DISTINCT
      ON (md.artist_address) md.artist_address,
      msg.chat_id
    FROM
      public.in_process_message_metadata md
